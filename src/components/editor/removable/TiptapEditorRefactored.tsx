...
import { RichTextProvider, RichTextToolbar } from "../toolbar";
...
interface TiptapEditorRefactoredProps {
  content?: string;
  onChange?: (html: string) => void;
  placeholder?: string;
}

export const TiptapEditorRefactored: React.FC<TiptapEditorRefactoredProps> = ({
  content = "",
  onChange,
...
export default TiptapEditorRefactored;
